...
namespace XBee
{
    ...
    {
        private static readonly Dictionary<HardwareVersion, DeviceSeries> Series =
            new Dictionary<HardwareVersion, DeviceSeries>
            {
                ...
                // map series 3 to 2 for now
                {HardwareVersion.XBee3, DeviceSeries.Series2 },
                {HardwareVersion.XBee3Smt, DeviceSeries.Series2 },
                {HardwareVersion.XBee3Th, DeviceSeries.Series2 }
            };
            ...
            switch (hardwareVersion)
            {
                ...
                case HardwareVersion.XBeeProS2:
                {
                    if (firmwareVersionHex.Length == 4 && firmwareVersionHex.StartsWith("1") &&
                        firmwareVersionHex.EndsWith("20")
                ...
                case HardwareVersion.XBee3:
                case HardwareVersion.XBee3Smt:
                case HardwareVersion.XBee3Th:
                {
                    if (firmwareVersionHex.StartsWith("2"))
                        return XBeeProtocol.Raw;
                    if (firmwareVersionHex.StartsWith("3"))
                        return XBeeProtocol.DigiMesh;
                    return XBeeProtocol.ZigBee;
                }
            }
