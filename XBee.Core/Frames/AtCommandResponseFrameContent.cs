...
namespace XBee.Frames
{
    internal class AtCommandResponseFrameContent
    {
        ...
        [Subtype("AtCommand", "SC", typeof(PrimitiveResponseData<ScanChannels>), BindingMode = BindingMode.OneWay)]
        ...
        [Subtype("AtCommand", "ID", typeof(PanIdResponseData), BindingMode = BindingMode.OneWay)]
        ...
        [Subtype("AtCommand", "PR", typeof(PullUpResistorConfigurationResponseData), BindingMode = BindingMode.OneWay)]
        ...
        [Subtype("AtCommand", "VR", typeof(PrimitiveResponseData<ushort>), BindingMode = BindingMode.OneWay)]
        [Subtype("AtCommand", "CE", typeof(CoordinatorEnableResponseData), BindingMode = BindingMode.OneWay)]
        [Subtype("AtCommand", "NP", typeof(PrimitiveResponseData<ushort>), BindingMode = BindingMode.OneWay)]
